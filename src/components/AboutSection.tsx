  ...
  return (
    <section id="about" className="py-24 px-6 lg:px-12 bg-white">
      <div className="max-w-7xl mx-auto">
        <p className="text-xs font-semibold tracking-[0.2em] text-dark/50 uppercase mb-12">
          03/ ABOUT ME
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              {["French", "English", "Arabic"].map((lang) => (
                <span
                  key={lang}
                  className="text-xs font-semibold px-3 py-1.5 bg-surface rounded-full border border-gray-200"
                >
                  {lang}
                </span>
              ))}
          ...
          <div className="bg-dark rounded-3xl p-8 text-white">
            <p className="text-lime text-xs font-bold tracking-[0.2em] uppercase mb-2">
              Technical Stack
            </p>
            <h3
                ...
                <div key={category}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {items.map((item) => (
                      <span
                        key={item}
                        className="text-xs font-medium px-3 py-1.5 bg-white/10 rounded-full text-white/80 hover:bg-lime hover:text-dark transition-all cursor-default"
                      >
                        {item}
                      </span>
                    ))}
            ...
            <div className="mt-8 pt-6 border-t border-white/10 grid grid-cols-2 gap-4">
              <div>
                <p className="text-2xl font-extrabold text-lime" style={{ fontFamily: "var(--font-syne)" }}>
                  INSEA
                </p>
